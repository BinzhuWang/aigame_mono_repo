...
const routes = [
  ...
  },
  {
    path: "/secondary",
    component: Layout,
    redirect: "/secondary/main",
    // meta: { title: "次级页面", icon: "" },
    children: [
      {
        path: "main",
        name: "main",
        component: () => import("@/views/secondary/index.vue"),
        meta: { name: "goal.json", icon: "table" },
      },
    ],
  },
  {
    path: "/third",
    component: Layout,
    redirect: "/third/main1",
    children: [
      {
        path: "main1",
        name: "main1",
        component: () => import("@/views/third/index.vue"),
        meta: { name: "plan.json", icon: "table" },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    name: "parseJson",
    component: Layout,
    redirect: "/parseJson/parseMain",
    children: [
      {
        path: "parseMain",
        name: "parseMain",
        component: () => import("../views/parseJson/index.vue"),
        meta: {
          requiresAuth: true, //有一些页面是否登录才能进去
          name: "parse.json",
        },
  ...
  },
  {
    ...
    name: "codePreview",
    component: Layout,
    redirect: "/codePreview/previewMain",
    children: [
      {
        path: "previewMain",
        name: "previewMain",
        component: () => import("../views/codePreview/index.vue"),
        meta: {
          requiresAuth: true, //有一些页面是否登录才能进去
          name: "code.json",
        },
